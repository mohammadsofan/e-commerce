  ...
  return (
    <div>
      ...
      >
          ...
          <div className="container text-center text-md-start mt-5">
            <div className="row mt-3">
              <div className="col-md-3 col-lg-4 col-xl-3 mx-auto mb-4">
                <h6 className="text-uppercase fw-bold">sof store</h6>
                <hr
                ...
                <p>
                  ...
                  iusto. Repellat nobis reprehenderit a consequatur, quam
                  laborum harum provident neque possimus quae, commodi!
                </p>
              </div>
        ...
        >
          © 2020 Copyright :<a className="text-dark">{` sofan.com`}</a>
        </div>
      </footer>
    </div>
  );
