...
export default function Navbar() {
  ...
  return (
        ...
        <div className="container">
          <a className="navbar-brand">
            ...
            >
              <path
                style={{ fill: "#95C675" }}
                d="M404.936,92.136c-1.768-0.168-39.52-2.968-39.52-2.968S339.176,63,336.304,60.12
	...
	C288.416,70.312,280.416,72.792,271.744,75.488z"
              ...
              <path
                style={{ fill: "#55932C" }}
                d="M311.04,493.72l151.824-33.008c0,0-53.288-362.088-53.624-364.576c-0.336-2.488-2.504-3.856-4.304-4
	...
	c-5.76,9.76-4.568,28.296-4.568,28.296L307.88,493.12L311.04,493.72z"
              ...
              <path
                style={{ fill: "#4A7A2B" }}
                d="M259.528,14.68c-0.752,0-1.528,0.032-2.312,0.08c-7.728-10.264-17.312-14.752-25.592-14.752
	...
	c13.968,1.744,23.296,17.704,29.296,36.064l15.504-4.808C302.112,37.872,286.672,14.68,259.528,14.68z"
              ...
              <path
                style={{ fill: "#4C822A" }}
                d="M371.752,89.648c-3.792-0.296-6.344-0.48-6.344-0.48S339.168,63,336.296,60.12
